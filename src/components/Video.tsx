    ...
    return (
        <div className="flex-1">
            <div className="bg-black">
                <div className="h-full w-full max-w-[1100px] max-h-[60vh] aspect-video items-center">
                    <Player>
                        <Youtube videoId="S04-izct7Mc" />
                        <DefaultUi />
                    </Player>
                </div>
            </div>
                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img  className="n-16 w-16 rounded-full border-2 border-blue-500"
